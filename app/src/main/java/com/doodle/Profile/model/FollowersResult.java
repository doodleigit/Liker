...
public class FollowersResult implements Serializable, Parcelable
{
    ...
    public final static Creator<FollowersResult> CREATOR = new Creator<FollowersResult>() {
        ...
        public FollowersResult createFromParcel(Parcel in) {
            return new FollowersResult(in);
        }

        public FollowersResult[] newArray(int size) {
            return (new FollowersResult[size]);
        }
    ...
    protected FollowersResult(Parcel in) {
