...
public class FollowingResult implements Serializable, Parcelable
{
    ...
    public final static Creator<FollowingResult> CREATOR = new Creator<FollowingResult>() {


        @SuppressWarnings({
            "unchecked"
        })
        public FollowingResult createFromParcel(Parcel in) {
            return new FollowingResult(in);
        }

        public FollowingResult[] newArray(int size) {
            return (new FollowingResult[size]);
        }

    }
    ;
    private final static long serialVersionUID = 9038219269519825031L;

    protected FollowingResult(Parcel in) {
