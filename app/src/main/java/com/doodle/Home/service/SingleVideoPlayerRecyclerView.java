...
public class SingleVideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<PostFile> mediaObjects = new ArrayList<>();
    ...
    public SingleVideoPlayerRecyclerView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public SingleVideoPlayerRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
...
//                        .into(volumeControl);
    ...
    public void setMediaObjects(ArrayList<PostFile> mediaObjects){
