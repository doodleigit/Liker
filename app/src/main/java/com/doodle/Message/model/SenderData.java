...
package com.doodle.Message.model;
...
public class SenderData implements Serializable, Parcelable
{
    ...
    public final static Creator<SenderData> CREATOR = new Creator<SenderData>() {


        @SuppressWarnings({
            "unchecked"
        })
        public SenderData createFromParcel(Parcel in) {
            return new SenderData(in);
        }

        public SenderData[] newArray(int size) {
            return (new SenderData[size]);
        }

    }
    ;
    private final static long serialVersionUID = 4811279921255723739L;

    protected SenderData(Parcel in) {
