...
public class PeopleMayKnow implements Serializable, Parcelable
{
    ...
    public final static Creator<PeopleMayKnow> CREATOR = new Creator<PeopleMayKnow>() {


        @SuppressWarnings({
            "unchecked"
        })
        public PeopleMayKnow createFromParcel(Parcel in) {
            return new PeopleMayKnow(in);
        }

        public PeopleMayKnow[] newArray(int size) {
            return (new PeopleMayKnow[size]);
        }

    }
    ;
    private final static long serialVersionUID = -4765136581238815726L;

    protected PeopleMayKnow(Parcel in) {
